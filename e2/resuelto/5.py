...
nuevo_numero = 2
movimiento_invalido_izquierda = False
movimiento_invalido_derecha = False
...
while True:
    ...
    if (numero_1 == numero_1_anterior and numero_2 == numero_2_anterior and numero_3 == numero_3_anterior):
        ...
        if direccion == "izquierda":
            movimiento_invalido_izquierda = True
        else:
            movimiento_invalido_derecha = True

        if movimiento_invalido_izquierda and movimiento_invalido_derecha:
            print('El juego ha terminado! Ya no hay movimientos posibles')
            break
        else:
            continue
    else:
        ...
        # Dejamos el movimiento como válido
        movimiento_invalido_izquierda = False
        movimiento_invalido_derecha = False
