...
## Ej: movimiento(numero_1, numero_2, numero_3, numero_4, 'izquierda')
##     movimiento(numero_5, numero_6, numero_7, numero_8, 'izquierda')
##     movimiento(numero_9, numero_10, numero_11, numero_12, 'izquierda')
##     movimiento(numero_13, numero_14, numero_15, numero_16, 'izquierda')
